(function(){
  ...
  document.querySelectorAll('.buy-basic, .buy-pro').forEach(a => {
    a.addEventListener('click', function(){
      ...
      const plan = isPro ? 'Combo Guitarrista Pro' : 'Basico';
  ...
  document.querySelectorAll('.whatsapp-float').forEach(a => {
    a.addEventListener('click', function(){
      const eventId = window.truckerCapMeta.newEventId('WhatsAppClick');
      if (PIXEL_ENABLED) fbq('trackCustom', 'WhatsAppClick', {
